                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <td><img src="/assets/image/product/<?= $row->image;?>" class="img"></td>
                                            <td>
                                                <div class="container">
                                                <button type="button" class="btn btn-warning " data-bs-toggle="modal" data-bs-target="#edit<?= $row->product_id;?>">
                                                <i class="fas fa-user-edit"></i>
                                                </button>   
                                                 <a class="btn btn-danger"  onclick="return confirm('Apakah Anda Yakin?')" href="product/delete/<?= $row->product_id;?>"><i class="fas fa-user-minus"></i></a>
                                                </div>
                                                </td>
                                        </tr>
                                        <?php endforeach; ?>
...
<div class="modal fade" id="edit<?= $row->product_id;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form  action="/product/edit/<?= $row->product_id;?>" method="POST">
                <?= csrf_field(); ?>
                ...
                <div class="form-floating mb-3">
                    <input type="text"  value="<?= $row->deskripsi;?>" class="form-control" name="product_price" placeholder="name@example.com" required >
