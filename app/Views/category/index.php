                                    ...
                                    <td><?= $row->stok;?></td>
                                            <td>
                                                ...
                                                <i class="fas fa-user-edit"></i>
                                                 ...
                                                 <a class="btn btn-danger"  onclick="return confirm('Apakah Anda Yakin?')" href="category/delete/<?= $row->category_id;?>"><i class="fas fa-user-minus"></i></a>
                                                </div>
                                                </td>
                                        </tr>
                                        <?php endforeach; ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="/category/save" enctype="multipart/form-data">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="stok" placeholder="name@example.com" required/>
                    <label for="latitude">Stok Produk </label>
                </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form  action="/category/edit/<?= $row->category_id;?>" method="POST">
                ...
                <div class="form-floating mb-3">
                    <input type="text"  value="<?= $row->stok;?>" class="form-control" id="no_req" name="stok" placeholder="name@example.com" required >
                    <label for="latitude">Stok Produk</label>
                </div>
      </div>
      <div class="modal-footer">
